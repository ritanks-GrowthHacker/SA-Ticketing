-- =============================================
-- MINIMAL NESTED COMMENTS SETUP - FIXED VERSION
-- =============================================
...
-- This will only run if the tables exist and have the required columns
DO $$
BEGIN
...
-- 5. Add foreign key constraint only if organizations table exists
DO $$
BEGIN
    ...
    ELSE
        RAISE NOTICE 'Skipped foreign key constraint - organizations table does not exist';
    END IF;
EXCEPTION
...
-- The system will work even if some constraints couldn't be added.